 ...
 *  │                                                             │
 *  │   TX(D1) ──→ 主機C 對應 RX 腳位                              │
 *  │              Arduino A  TX(D5)→ 主機 D0 (SoftwareSerial RX)  │
 *  │              Arduino A  RX(D4)→ 主機 D1 (SoftwareSerial TX)  │
 *  │              Arduino B  TX(D5)→ 主機 D4 (SoftwareSerial RX)  │
 *  │              Arduino B  TX(D4)→ 主機 D5 (SoftwareSerial TX)  │
 *  │                                                             │
